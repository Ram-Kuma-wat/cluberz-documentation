...
- **Vendor Panel** scope from [final-vendor-panel.md](final-vendor-panel.md)
- **Customer Panel** scope from [final-customer-panel.md](final-customer-panel.md)
- **Admin Panel** scope from [final-admin-panel.md](final-admin-panel.md)
